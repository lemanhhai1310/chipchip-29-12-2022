...
<div class="uk-grid uk-grid-10 item__10" uk-grid>
    <div class="uk-width-1-2 uk-width-auto@s">
        <a href="" class="uk-button header__btn uk-width-1-1 uk-width-auto@s uk-button-primary uk-border-pill">Đặt lớp học thử</a>
    </div>
    <div class="uk-width-1-2 uk-width-auto@s">
        <a href="" class="uk-button header__btn uk-width-1-1 uk-width-auto@s uk-button-default uk-border-pill">Nhắn tin</a>
    </div>
</div>