...
<div class="uk-background-muted uk-section-xsmall" uk-height-viewport="expand: true">
    <div class="uk-container">
        <div class="uk-hidden@m">
            <ul class="uk-subnav lophoc__tab uk-subnav-pill" uk-switcher>
            ...
            <ul class="uk-switcher uk-margin">
                <li>
                    ...
                    <div class="uk-grid uk-margin uk-child-width-1-4@m uk-grid-small uk-grid-match" uk-grid>
                        <div>
                            <div class="uk-card lophoc__card uk-card-body uk-card-default uk-padding-small uk-border-rounded">
                                <div class="lophoc__card__box uk-border-rounded">
                                    <div class="uk-flex-middle uk-grid-5" uk-grid>
                                        <div class="uk-width-expand">
                                            <div class="lophoc__card__txt1">Đã đặt lịch</div>
                                        </div>
                                ...
                                <div class="uk-margin-small-top"><a href="" class="lophoc__card__btn lophoc__card__btn--vaolop uk-button uk-button-primary uk-width uk-border-pill">Vào lớp học</a></div>
                                <div class="item__8"><a href="" class="lophoc__card__btn lophoc__card__btn--hocthu uk-button uk-button-default uk-width uk-border-pill">Hướng dẫn học thử</a></div>
                            </div>
                        </div>
                        <div>
                            <div class="uk-card lophoc__card uk-card-body uk-card-default uk-padding-small uk-border-rounded">
                    ...
                    <div class="uk-text-center lophoc__txtSmall">Để trải nghiệm học thử được tốt nhất, vui lòng truy cập vào lớp trên máy tính sử dụng trình duyệt Google Chrome; hoặc tải app Chip Chip Students trên máy tính bảng.</div>
                </li>
                <li></li>
            </ul>
        </div>
